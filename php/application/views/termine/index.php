					...
					<table class="table">
						<tr>
							<?php if (isset($termin->Heim))  {
										if (isset($termin->Sparte)) echo "<td width='10'>".$termin->Sparte."</td>";
										if (isset($termin->Heim)) echo "<td width='30'>".$termin->Heim."</td>";
										if (isset($termin->Heimtore)) echo "<td width='10'>".$termin->Heimtore."</td><td width='5'>:</td>";
										...
										if (isset($termin->Trainingsgruppe)) echo "<td width='25'>".$termin->Trainingsgruppe."</td>";
