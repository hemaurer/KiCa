...
<div class="accordion vertical">
	...
	<div class="insection">
        ...
        <form action="<?php echo URL; ?>verwaltung/add_person" method="POST">
            ...
            <input type="date" name="d_gebdatum" value="" required/>
			<label>Groesse</label>
            <input type="number" name="int_groesse" value="" />
			<label>Bild</label>
            <input type="file" name="str_bild" value="" />
            ...
            <input type="tel" name="int_tel" value="" />
...
<?php /***Spiele-Container***/?>
	...
	<section id="spiel">
        ...
        <form action="<?php echo URL; ?>verwaltung/add_spiel" method="POST">
			...
			<label>Zeit</label>
            <input type="datetime-local" name="d_zeit" value="" required/>
