...
class LigaModel
{
    ...
    public function get_ligatabelle($s_id)
    {
        ...
        $sql = "SELECT mannschaft.name AS Team,
                ...
                CONCAT((SELECT SUM(spiel.h_tore) FROM spiel WHERE spiel.heim = mannschaft.m_id and spiel.stat_id = 1  and spiel.tu_id = 1 and spiel.sparte_id = :s_id) +  (SELECT SUM(spiel.a_tore) FROM spiel WHERE spiel.auswaerts = mannschaft.m_id and spiel.stat_id = 1  and spiel.tu_id = 1 and spiel.sparte_id = :s_id),':',
                (SELECT SUM(spiel.h_tore) FROM spiel WHERE spiel.auswaerts = mannschaft.m_id and spiel.stat_id = 1 and spiel.tu_id = 1 and spiel.sparte_id = :s_id) +  (SELECT SUM(spiel.a_tore) FROM spiel WHERE spiel.heim = mannschaft.m_id and spiel.stat_id = 1 and spiel.tu_id = 1 and spiel.sparte_id = :s_id)) AS Tore,
                (SELECT SUM(spiel.h_tore) FROM spiel WHERE spiel.heim = mannschaft.m_id and spiel.stat_id = 1 and spiel.tu_id = 1 and spiel.sparte_id = :s_id) +  (SELECT SUM(spiel.a_tore) FROM spiel WHERE spiel.auswaerts = mannschaft.m_id and spiel.stat_id = 1 and spiel.tu_id = 1 and spiel.sparte_id = :s_id) -
                ((SELECT SUM(spiel.h_tore) FROM spiel WHERE spiel.auswaerts = mannschaft.m_id and spiel.stat_id = 1 and spiel.tu_id = 1 and spiel.sparte_id = :s_id) + (SELECT SUM(spiel.a_tore) FROM spiel WHERE spiel.heim = mannschaft.m_id and spiel.stat_id = 1 and spiel.tu_id = 1 and spiel.sparte_id = :s_id)) AS TD
                FROM mannschaft
